...
//все товары 
var  allProducts = {
   burgertwo: { title : 'Двойной бургер', price : 500, src : 'burger/1.jpg' },
   burger: { title : 'Классический бургер', price : 250, src : 'burger/2.jpg' },
   chickenburger: { title : 'ЧикенБургер', price : 200, src : 'burger/3.jpg' }
};
...
class CartItem {
    ...
    renderWithIndex(index) {
        ...
        <img class="goods-list__product-box__img" src=${this.src} width="110px" height="100px" alt="">
